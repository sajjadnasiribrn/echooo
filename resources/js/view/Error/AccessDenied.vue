<template>
    <div class="d-flex flex-column align-center justify-center mx-3">
        <p class="display-1 mt-12 mb-6 red--text">شما به این قسمت دسترسی ندارید.</p>
        <router-link to="/" class="mb-6">باز گشت به صفحه اصلی</router-link>
        <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" height="60vh"
            ...
            <path
                ...
                transform="translate(-74.56 -1.95)" fill="#0d3bae" opacity="0.18" style="isolation:isolate"/>
            <path
                ...
                transform="translate(-74.56 -1.95)" fill="#fff" stroke="#0d3bae" stroke-miterlimit="10"
                stroke-width="1.29"/>
            <rect x="15.7" y="85.45" width="146.38" height="13.84" rx="6.92" fill="#0d3bae" opacity="0.18"
                  style="isolation:isolate"/>
            <rect x="15.7" y="104.87" width="146.38" height="94.92" rx="6.92" fill="#0d3bae" opacity="0.18"
                  style="isolation:isolate"/>
            <circle cx="210.39" cy="132.73" r="28.45" fill="#0d3bae" opacity="0.18" style="isolation:isolate"/>
            <path
            ...
            <rect x="48.84" y="90.97" width="87.29" height="173.81" rx="15.37" fill="#0d3bae"/>
            <rect x="48.84" y="90.97" width="87.29" height="173.81" rx="15.37" fill="url(#linear-gradient-3)"/>
            <rect x="48.84" y="90.79" width="87.29" height="170.11" rx="15.21" fill="#0d3bae"/>
            ...
            <path
                ...
                transform="translate(-74.56 -1.95)" fill="#0d3bae"/>
            <path
            ...
            <path
                ...
                transform="translate(-74.56 -1.95)" fill="#f7af87"/>
            <path d="M347.15,51.73H75.34A18.37,18.37,0,0,1,93.6,35.46H328.89A18.37,18.37,0,0,1,347.15,51.73Z"
                  transform="translate(-74.56 -1.95)" fill="#0d3bae"/>
            <path
            ...
            <path
                ...
                transform="translate(-74.56 -1.95)" fill="#0d3bae"/>
            <circle cx="78.93" cy="129.51" r="4.79" fill="#0d3bae" opacity="0.18" style="isolation:isolate"/>
            <circle cx="91.56" cy="129.51" r="4.79" fill="#0d3bae" opacity="0.18" style="isolation:isolate"/>
            <circle cx="104.18" cy="129.51" r="4.79" fill="#0d3bae" opacity="0.18" style="isolation:isolate"/>
            <rect x="15.7" y="62.15" width="146.38" height="13.84" rx="6.92" fill="#0d3bae" opacity="0.18"
                  style="isolation:isolate"/>
