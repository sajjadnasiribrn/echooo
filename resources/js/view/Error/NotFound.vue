<template>
    <div class="d-flex flex-column align-center justify-center mx-3">
        <p class="display-1 mt-12 mb-6">صفحه مد نظر شما پیدا نشد!</p>
        <router-link to="/" class="mb-6">باز گشت به صفحه اصلی</router-link>
        <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
             height="60vh"
             xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 315.35 305.59">
            <defs>
                <linearGradient id="linear-gradient" x1="156.72" y1="259" x2="159.63" y2="341.54"
                                gradientUnits="userSpaceOnUse">
                    <stop offset="0" stop-opacity="0"/>
                    <stop offset="0.95"/>
                </linearGradient>
                <linearGradient id="linear-gradient-2" x1="67.7" y1="231.63" x2="64.79" y2="116.55"
                                gradientUnits="userSpaceOnUse">
                    <stop offset="0" stop-opacity="0"/>
                    <stop offset="0.99"/>
                </linearGradient>
                <linearGradient id="linear-gradient-3" x1="256" y1="215.77" x2="254.06" y2="143.58"
                                xlink:href="#linear-gradient"/>
                <linearGradient id="linear-gradient-4" x1="154.93" y1="238.45" x2="159.46" y2="81.77"
            ...
            <path
                ...
                transform="translate(-58.19 0.8)" fill="#2a2727" opacity="0.18" style="isolation:isolate"/>
            <ellipse cx="157.68" cy="286.11" rx="157.68" ry="19.48" fill="#2a2727"/>
            ...
            <path
                ...
                transform="translate(-58.19 0.8)" fill="#eea886"/>
            <polygon points="58.79 180.31 73.36 239.23 73.36 154.25 66.88 134.99 58.79 180.31"
            ...
            <path
                ...
                transform="translate(-58.19 0.8)" fill="#eea886"/>
            <polygon points="263.7 176.1 258.53 202.65 247.52 226.6 246.55 174.48 263.7 176.1"
                     fill="url(#linear-gradient-3)"/>
            <rect x="52.64" y="48.4" width="211.71" height="133.37" rx="8.37" fill="#2a2727"/>
            <rect x="52.64" y="48.4" width="211.71" height="133.37" rx="8.37" fill="url(#linear-gradient-4)"/>
            <rect x="52.64" y="43.05" width="211.71" height="133.37" rx="8.37" fill="#2a2727"/>
            <path
                ...
                transform="translate(-58.19 0.8)" fill="#fff"/>
            <path
            ...
            <path
                ...
                transform="translate(-58.19 0.8)" fill="#fff"/>
            <path d="M176.88,153.86h-6v5.55h6.67v1.67h-8.66V145.69h8.32v1.67H170.9v4.86h6Z"
                  transform="translate(-58.19 0.8)" fill="#fff"/>
            <path
            ...
            <path
                ...
                transform="translate(-58.19 0.8)" fill="#fff"/>
            <path d="M218.1,147.38h-4.68v-1.69h11.4v1.69h-4.71v13.7h-2Z" transform="translate(-58.19 0.8)" fill="#fff"/>
            <path d="M231.37,145.69h8.29v1.67h-6.3v5.11h5.82v1.64h-5.82v7h-2Z" transform="translate(-58.19 0.8)"
                  fill="#fff"/>
            <path
