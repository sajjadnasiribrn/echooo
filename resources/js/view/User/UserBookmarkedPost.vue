            ...
            <template v-if="posts.data">
                    ...
                    <v-col cols="12" md="8" class="mt-6">
                        ...
                        >
                            <v-row class="justify-center">
                                <p class="mt-10">
                                    <span class="caption">{{ user.bookmarks_count }}</span>
                                    <span class="caption"> نوشته را ذخیره کرده اید. </span>
                                </p>
                            </v-row>
                        </v-alert>
                    </v-col>
                ...
                <v-row class="d-flex justify-center">
                    <v-col cols="12" md="8">
                        ...
                        <span v-if="!posts.data.length">هنوز نوشته ای را ذخیره نکرده اید.</span>
                        <br><br><br><br>
                    </v-col>
                </v-row>
            </template>
