...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(props, _ref) {
    ...
    var show3 = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_0__["ref"])(false);
    ...
    var passwordRules = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_0__["ref"])([function (value) {
      return !!value || 'این فیلد ضروری است.';
    }, function (value) {
      return (value ? value.length >= 5 : false) || 'کلمه عبور بیشتر از 5 کاراکتر باشد.';
    }]);
    var passwordConfirmationRules = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_0__["ref"])([function (value) {
      return !!value || 'این فیلد ضروری است.';
    }, function (value) {
      return (value ? value.length >= 5 : false) || 'کلمه عبور بیشتر از 5 کاراکتر باشد.';
    }, function (value) {
      return (value ? value == form.value.password : false) || 'کلمه عبور با تکرار آن همخوانی ندارد.';
    }]);

    function changePassword() {
      if (refs.resetPassword.validate()) {
        loading.value = true;
        _store__WEBPACK_IMPORTED_MODULE_1__["default"].dispatch('resetPassword', form.value).then(function () {
          root.$router.push({
            name: 'home'
          });
