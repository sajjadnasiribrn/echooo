...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "d-flex flex-column align-center justify-center text-center mx-3 mt-7"
    },
    [
      _c(
        "svg",
        ...
        [
            ...
            [
              _c(
                ...
                [
                  ...
                  _vm._v(" "),
                  _c("stop", {
                    attrs: { offset: "0.95", "stop-color": "#010101" }
                  })
                ],
                1
              ),
              ...
              _c(
                ...
                [
                  ...
                  _vm._v(" "),
                  _c("stop", {
                    attrs: { offset: "0.95", "stop-color": "#fff" }
                  })
                ],
                1
              ),
              ...
              _c("linearGradient", {
                attrs: {
                  ...
                  x2: "317.68",
                  y2: "121.46",
                  gradientTransform: "matrix(-1, 0, 0, 1, 548.7, 0)",
                  "xlink:href": "#linear-gradient-5"
                }
              }),
              _vm._v(" "),
              ...
              _c("linearGradient", {
                attrs: {
                  ...
                  x2: "744.23",
                  y2: "697.88",
                  gradientTransform: "translate(-843.27 256.71) rotate(-48.02)",
                  "xlink:href": "#linear-gradient-5"
                }
              }),
              _vm._v(" "),
              ...
              _c(
                "clipPath",
                {
                  attrs: {
                    id: "clip-path",
                    transform: "translate(-17.43 -10.2)"
                  }
                },
                [
                  _c("path", {
                    attrs: {
                      d:
                        "M258.26,232.1l66.63,12.19v-61.1A28.23,28.23,0,0,0,296.66,155h0c-15.6,0-30.6,15.66-30.6,31.25Z",
                      fill: "none"
                    }
                  })
                ]
              ...
              _c("linearGradient", {
                attrs: {
                  ...
                  x2: "635.71",
                  y2: "720.72",
                  gradientTransform: "translate(-621.71 -30.83) rotate(-32.49)",
                  "xlink:href": "#linear-gradient-5"
                }
              }),
              _vm._v(" "),
          ...
          _c("path", {
            ...
            attrs: {
              d:
                "M536,348.16a71,71,0,0,1-7.51,18c-19.19,33.49-56.78,52.85-94.59,60.77s-76.87,6.18-115.45,7.95c-52.12,2.36-104.1,11.11-156.22,8.24A352.33,352.33,0,0,1,89.2,431.24c-16-4.35-49.06-10-58.74-24.87-6.05-9.25-7-26.58-7.25-41.18,3.62.57,7.22,1.43,10.38,1.73,10.71,1,21.55,1.1,32.29,1.43q34.13,1.09,68.28,1.46,136,1.45,271.8-8.94Q471.12,355.88,536,348.16Z",
              transform: "translate(-17.43 -10.2)",
              fill: "#e040fb",
              opacity: "0.24"
            }
          ...
          _c("path", {
            attrs: {
              d:
                "M439.15,182.37V244.9H263.83V182.37a32.59,32.59,0,0,1,32.63-32.59H406.52A32.62,32.62,0,0,1,439.15,182.37Z",
              transform: "translate(-17.43 -10.2)",
              fill: "#e040fb"
            }
          }),
          ...
          _c("path", {
            attrs: {
              d:
                "M279.16,145h0a28.23,28.23,0,0,1,28.23,28.23v61.1a0,0,0,0,1,0,0H250.93a0,0,0,0,1,0,0v-61.1A28.23,28.23,0,0,1,279.16,145Z",
          ...
          _c("path", {
            attrs: {
              d:
                "M439.16,182.36v62.53h-108V178.7c-3.23-17.29-15.4-25.24-25.42-28.9H406.54A32.6,32.6,0,0,1,439.16,182.36Z",
              transform: "translate(-17.43 -10.2)",
          ...
          _c("path", {
            attrs: {
              d:
                "M145.05,145.21c-.16-2.84.17-5.82-1-8.41a10.67,10.67,0,0,0-5.24-5,37.23,37.23,0,0,0-7-2.26,154.65,154.65,0,0,1-18.21-5.9c.59,4.25,4.06,7.43,7.31,10.23a6.17,6.17,0,0,0-2,.87,2.08,2.08,0,0,0-.9,1.92,2.68,2.68,0,0,0,.84,1.36,10.47,10.47,0,0,0,4.88,2.74l-5,2.06a1.14,1.14,0,0,0-.61.43c-.22.39.08.86.4,1.17,2.41,2.36,6.26,2.11,9.6,1.7a12.51,12.51,0,0,0-4.23,3.3.72.72,0,0,0-.23.6c.07.26.39.35.66.39a15.28,15.28,0,0,0,8.64-1.29,5.91,5.91,0,0,0-1.79,2.38c-.09.23-.17.52,0,.71a.69.69,0,0,0,.5.19,9.5,9.5,0,0,0,6.74-1.93,4.41,4.41,0,0,0,3.17,3.68,13.14,13.14,0,0,0,5.12.34c3.45-.24,1.35-2.21.2-3.67A10,10,0,0,1,145.05,145.21Z",
              transform: "translate(-17.43 -10.2)",
              fill: "#e040fb"
            }
          }),
          ...
          _c("path", {
            attrs: {
              d:
                "M219.8,136.07c.24-4.16-.25-8.52,1.45-12.32a15.64,15.64,0,0,1,7.67-7.29,54.33,54.33,0,0,1,10.26-3.3,228.54,228.54,0,0,0,26.64-8.63c-.87,6.21-5.95,10.87-10.7,15a8.87,8.87,0,0,1,3,1.27,3,3,0,0,1,1.32,2.8,3.87,3.87,0,0,1-1.23,2,15.22,15.22,0,0,1-7.14,4l7.32,3a1.66,1.66,0,0,1,.89.63c.32.57-.12,1.26-.58,1.71-3.53,3.45-9.16,3.09-14.05,2.49a18.36,18.36,0,0,1,6.19,4.83,1,1,0,0,1,.33.88c-.1.38-.57.51-1,.57a22.55,22.55,0,0,1-12.64-1.88,8.53,8.53,0,0,1,2.63,3.48,1,1,0,0,1,0,1,1,1,0,0,1-.74.28,13.91,13.91,0,0,1-9.85-2.83c-.11,2.52-2.26,4.58-4.64,5.4a19.22,19.22,0,0,1-7.49.48c-5.06-.34-2-3.23-.29-5.36C219,142,219.63,138.91,219.8,136.07Z",
              transform: "translate(-17.43 -10.2)",
              fill: "#e040fb"
            }
          }),
          ...
          _c("path", {
            attrs: {
              d:
                "M227.24,135.75c.16-2.84-.17-5.82,1-8.42a10.72,10.72,0,0,1,5.24-5,37,37,0,0,1,7-2.25,157.2,157.2,0,0,0,18.21-5.91c-.6,4.25-4.07,7.44-7.32,10.24a6.06,6.06,0,0,1,2,.86,2.1,2.1,0,0,1,.91,1.92,2.72,2.72,0,0,1-.85,1.37,10.35,10.35,0,0,1-4.88,2.73l5,2.07a1.09,1.09,0,0,1,.6.42c.22.39-.08.87-.39,1.18-2.41,2.35-6.26,2.1-9.6,1.7a12.35,12.35,0,0,1,4.22,3.3.68.68,0,0,1,.23.6c-.07.26-.39.35-.66.39a15.39,15.39,0,0,1-8.64-1.29,5.87,5.87,0,0,1,1.8,2.38.73.73,0,0,1,0,.7.71.71,0,0,1-.51.2,9.53,9.53,0,0,1-6.73-1.94,4.44,4.44,0,0,1-3.17,3.69,13,13,0,0,1-5.13.33c-3.45-.23-1.34-2.21-.19-3.66A10.12,10.12,0,0,0,227.24,135.75Z",
              transform: "translate(-17.43 -10.2)",
              fill: "#e040fb"
            }
          }),
          ...
          _c("rect", {
            attrs: {
              ...
              width: "75.31",
              height: "46.42",
              transform: "translate(-34.38 10.14) rotate(-5.91)",
              fill: "#e040fb"
            }
          }),
          _vm._v(" "),
          _c("polygon", {
            attrs: {
              points:
                "210.87 183.35 135.96 191.1 131.18 144.93 207.46 136.44 210.87 183.35",
          ...
          _c("polygon", {
            attrs: {
              points: "131.18 144.93 172.71 179.18 206.44 137.83 131.18 144.93",
              fill: "url(#linear-gradient-10)"
            }
          }),
          _vm._v(" "),
          _c("circle", {
            attrs: { cx: "208.4", cy: "136.71", r: "10.49", fill: "#e040fb" }
          }),
          _vm._v(" "),
          _c("circle", {
            attrs: {
          ...
          _vm._v(" "),
          _c("g", { attrs: { "clip-path": "url(#clip-path)" } }, [
            _c("rect", {
              attrs: {
                x: "293",
                y: "193.86",
                width: "68.36",
                height: "42.14",
                transform: "translate(23.11 -61.87) rotate(9.62)",
                fill: "#e040fb"
              }
            }),
            _vm._v(" "),
            _c("polygon", {
              attrs: {
                points:
                  "339.93 231.22 272.52 219.79 279.57 178.25 348.35 189.36 339.93 231.22",
            ...
            _c("polygon", {
              attrs: {
                points:
                  "279.57 178.25 307.56 218.3 347.12 190.33 279.57 178.25",
            ...
            _c("rect", {
              attrs: {
                ...
                width: "49.94",
                height: "30.79",
                transform: "translate(17.68 -59.21) rotate(9.62)",
                fill: "#e040fb"
              }
            }),
            _vm._v(" "),
            _c("polygon", {
              attrs: {
                points:
                  "313.25 193.18 264.01 184.83 269.16 154.48 319.4 162.6 313.25 193.18",
            ...
            _c("polygon", {
              attrs: {
                points:
                  "269.16 154.48 289.61 183.74 318.5 163.31 269.16 154.48",
      ...
      _vm._v(" "),
      _c("p", { staticClass: "display-1 mt-12 mb-6 green--text" }, [
        _vm._v("خوش آمدید!")
      ]),
      _vm._v(" "),
      _c("p", { staticClass: "font-weight-bold mt-12 mb-6 red--text" }, [
        _vm._v(
          "\n        ایمیلی برای شما ارسال شد،\n        با مراجعه به آن حساب کاربری خود را فعال کنید.\n    "
        )
      ]),
      _vm._v(" "),
      _c("v-btn", { staticClass: "mb-6", attrs: { to: "/", color: "info" } }, [
        _vm._v("رفتن به صفحه اصلی")
      ])
    ],
    1
  )
