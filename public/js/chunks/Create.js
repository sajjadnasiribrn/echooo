...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(props, _ref) {
    ...
    var isSuccess = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_2__["ref"])(false);
    ...
    var draftId = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_2__["ref"])(0);
    ...
    var updateDraft = Object(lodash__WEBPACK_IMPORTED_MODULE_1__["debounce"])(function () {
      updateDraftStore().then(function (_ref3) {
        ...
        if (requestType.value === 'post') {
          history.replaceState({}, '', "/drafts/".concat(data.link));
          root.$route.params.link = data.link;
          draftId.value = data.id;
          requestURI.value = "/api/drafts/".concat(data.link);
        }
  ...
  return _c(
    ...
    [
        ...
        [
          _c(
            ...
            [
              ...
              _c("br"),
              _vm._v(" "),
              _vm.requestURI != "/api/posts/create" && !_vm.isSuccess
                ? [_c("SkeletonLoader")]
                : _c(
                    "v-form",
                    { staticClass: "editor mx-4 body-text" },
                    [
                      _c("v-textarea", {
                        staticClass: "f-big",
                        attrs: {
      ...
      _c(
        "v-snackbar",
        {
          attrs: { top: "", timeout: 1300, color: "info" },
          model: {
